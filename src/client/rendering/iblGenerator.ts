// src/client/rendering/iblGenerator.ts
...
import {
  ...
  IblPipelines,
} from "@/client/rendering/ibl";
import { loadEXR } from "@/shared/loaders/exrLoader";
import { loadHDR } from "@/shared/loaders/hdrLoader";
...
import { SkyboxMaterial } from "@/client/rendering/materials/skyboxMaterial";
